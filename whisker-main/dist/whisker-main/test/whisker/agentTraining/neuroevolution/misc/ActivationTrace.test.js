...
describe("Activation Trace", () => {
    ...
    beforeEach(() => {
        ...
        activationTrace = new ActivationTrace_1.ActivationTrace(nodeTraces[0][0]);
    });
    test("Update AT with new node activations", () => {
        ...
        for (const repetition of nodeTraces) {
            for (const nodes of repetition) {
                const id = "New";
                const iNodeActivated = new InputNode_1.InputNode(0, id, 'Activated');
                const iNodeDeactivated = new InputNode_1.InputNode(1, id, 'Deactivated');
