...
const NeatestParameter_1 = require("../../../../../src/whisker/agentTraining/neuroevolution/hyperparameter/NeatestParameter");
describe("Test NeatProperties", () => {
    test("Test Getter and Setter", () => {
        const properties = new NeatestParameter_1.NeatestParameter();
        ...
        properties.stoppingCondition = new OptimalSolutionStoppingCondition_1.OptimalSolutionStoppingCondition();
        properties.networkFitness = null;
        properties.timeout = 20000;
        properties.eventSelection = 'activation';
        properties.numberOfSpecies = 10;
        properties.activationFunction = ActivationFunction_1.ActivationFunction.TANH;
        ...
        expect(properties.stoppingCondition).toBeInstanceOf(OptimalSolutionStoppingCondition_1.OptimalSolutionStoppingCondition);
        ...
        expect(properties.activationFunction).toBe(ActivationFunction_1.ActivationFunction.TANH);
