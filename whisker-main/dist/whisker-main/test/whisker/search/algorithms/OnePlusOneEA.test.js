...
const OnePlusOneEA_1 = require("../../../../src/whisker/search/algorithms/OnePlusOneEA");
...
describe('OnePlusOneEa', () => {
    ...
    test('Setter', () => {
        const stoppingCondition = new OneOfStoppingCondition_1.OneOfStoppingCondition(new FixedIterationsStoppingCondition_1.FixedIterationsStoppingCondition(1000), // Plenty time...
        ...
        const search = new OnePlusOneEA_1.OnePlusOneEA();
