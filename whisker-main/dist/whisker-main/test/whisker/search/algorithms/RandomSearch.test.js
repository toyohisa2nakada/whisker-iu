...
describe('RandomSearch', () => {
    ...
    test('Trivial bitstring with OneMax', () => __awaiter(void 0, void 0, void 0, function* () {
        const properties = {
            populationSize: 1,
            chromosomeLength: 2,
        ...
        const solutions = yield randomSearch.findSolution();
    ...
    test('Setter', () => {
        const stoppingCondition = new OneOfStoppingCondition_1.OneOfStoppingCondition(new FixedIterationsStoppingCondition_1.FixedIterationsStoppingCondition(1000), new OptimalSolutionStoppingCondition_1.OptimalSolutionStoppingCondition());
        const properties = {
            populationSize: 1,
            chromosomeLength: 2,
            stoppingCondition,
        ...
        const randomSearch = new RandomSearch_1.RandomSearch();
