...
const MOSA_1 = require("../../../../src/whisker/search/algorithms/MOSA");
...
describe('MOSA', () => {
    ...
    beforeEach(() => {
        ...
        builder
            ...
            .initializeFitnessFunction(FitnessFunctionType_1.FitnessFunctionType.SINGLE_BIT, chromosomeLength, []);
        searchAlgorithm = builder.buildSearchAlgorithm();
    });
    test('BitstringChromosome with SingleBitFitnessFunction', () => __awaiter(void 0, void 0, void 0, function* () {
