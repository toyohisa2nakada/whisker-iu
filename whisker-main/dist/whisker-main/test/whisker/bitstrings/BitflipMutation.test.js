...
describe('BitflipMutation', () => {
    test('False to true', () => __awaiter(void 0, void 0, void 0, function* () {
        const originalBits = [false];
        const chromosome = new BitstringChromosome_1.BitstringChromosome(originalBits, new BitflipMutation_1.BitflipMutation(), new SinglePointCrossover_1.SinglePointCrossover());
        const mutation = new BitflipMutation_1.BitflipMutation();
    ...
    test('True to false', () => __awaiter(void 0, void 0, void 0, function* () {
