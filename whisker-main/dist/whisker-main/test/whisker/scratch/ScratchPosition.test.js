...
describe("ScratchPosition Test", () => {
    let position;
    beforeEach(() => {
        position = new ScratchPosition_1.ScratchPosition(1, 1);
    });
    test("Test distanceTo", () => {
        const otherPosition = new ScratchPosition_1.ScratchPosition(-6, 1);
    ...
    test("Test equals", () => {
        const otherPosition = new ScratchPosition_1.ScratchPosition(1, 0);
        const clone = position.clone();
