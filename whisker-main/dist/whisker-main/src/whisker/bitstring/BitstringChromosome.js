...
exports.BitstringChromosome = void 0;
const ListChromosome_1 = require("../search/ListChromosome");
class BitstringChromosome extends ListChromosome_1.ListChromosome {
    constructor(bits, mutationOp, crossoverOp) {
        super(bits);
...
exports.BitstringChromosome = BitstringChromosome;
