...
exports.NonExhaustiveCaseDistinction = void 0;
/**
 ...
 */
class NonExhaustiveCaseDistinction extends Error {
    /**
     ...
     */
    constructor(unhandled, message = `Unhandled value: ${unhandled}`) {
        super(message);
    }
}
exports.NonExhaustiveCaseDistinction = NonExhaustiveCaseDistinction;
