...
exports.FeatureExtractionUtil = void 0;
class FeatureExtractionUtil {
    /**
     ...
     */
    static addVariableFeatures(target, featureMap) {
     ...
     */
    static addCostumeFeature(target, featureMap) {
     ...
     */
    static getBlocksWithOpcode(target, opcode) {
     ...
     */
    static normaliseVariableValue(value, constant = 1) {
     ...
     */
    static mapValueIntoRange(value, input_start, input_end, output_start = -1, output_end = 1) {
...
exports.FeatureExtractionUtil = FeatureExtractionUtil;
