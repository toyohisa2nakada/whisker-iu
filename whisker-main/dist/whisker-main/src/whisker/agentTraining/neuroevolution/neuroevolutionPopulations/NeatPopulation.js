...
exports.NeatPopulation = void 0;
const NeuroevolutionPopulation_1 = require("./NeuroevolutionPopulation");
...
class NeatPopulation extends NeuroevolutionPopulation_1.NeuroevolutionPopulation {
    /**
    ...
    static getAvailableInnovationNumber() {
    ...
    evolve() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const specie of this.species) {
                offspring.push(...yield specie.evolve(this, this.species));
            }
            ...
            for (const doomedSpecie of doomedSpecies) {
                Arrays_1.default.remove(this.species, doomedSpecie);
            }
            this.generation++;
        });
    }
     ...
     */
    removeNetworkFromSpecie(chromosome) {
    ...
    updateCompatibilityThreshold() {
        ...
        logger_1.default.debug(`Current Compatibility Threshold: ${this._compatibilityThreshold}`);
    }
    /**
    ...
    assignNumberOfOffspring() {
        ...
        if (totalOffspringExpected < this.populationSize) {
            ...
            Randomness_1.Randomness.getInstance().pick(this.species).expectedOffspring += lostChildren;
        }
        ...
        if (this.highestFitnessLastChanged > this.hyperParameter.penalizingAge + 5) {
            logger_1.default.debug("Refocusing the search on the two most promising species");
            this.highestFitnessLastChanged = 0;
            ...
            // Otherwise, allow only the first two most promising species to reproduce and mark the others dead.
                ...
                for (let i = 0; i < this.species.length; i++) {
                    ...
                    // The other species are terminated.
                        ...
                        Arrays_1.default.clear(specie.networks);
                    }
                }
            }
            // TODO: Babies Stolen
     ...
     */
    assignRepresentatives(offspring) {
        for (const specie of this.species) {
    ...
    assignSpecies(network) {
        ...
        if (this.species.length === 0) {
            const newSpecies = new Species_1.Species(this.speciesCount, this.hyperParameter);
     ...
     */
    compatibilityDistance(network1, network2) {
     ...
     */
    static findInnovation(connection, innovationType) {
        let findMatchingInnovation;
    ...
    clone() {
        ...
        clone.populationChampion = this.populationChampion.clone();
        for (const network of this.networks) {
    ...
    set speciesCount(value) {
        this._speciesCount = value;
    }
    get species() {
        return this._species;
    }
    get numberOfSpeciesTargeted() {
...
exports.NeatPopulation = NeatPopulation;
/**
 ...
 */
NeatPopulation.highestNodeId = 0;
/**
 ...
 */
NeatPopulation.nodeToId = new Map();
/**
 * Used for determining the next available innovation number.
 */
NeatPopulation.innovationCounter = 0;
