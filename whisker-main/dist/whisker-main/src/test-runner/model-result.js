...
exports.modelResultToCsvData = exports.modelCsvHeader = exports.ModelResult = void 0;
class ModelResult {
    constructor() {
        /**
         * @type {number}
     ...
     */
    getCsvColumns() {
        const [current, repetition, total, edgeCount] = Object.values(this.coverage).reduce(([curr, rep, total, edges], covObj) => [curr + covObj.covered, rep + covObj.repetitionCovered, total + covObj.totalCovered, edges + covObj.total], [0, 0, 0, 0]);
...
exports.modelCsvHeader = ",modelFails,modelErrors,modelCoverage,repetitionModelCoverage,totalModelCoverage";
/**
 ...
 * @return {string|*[]}
 */
function modelResultToCsvData(result, defaultValue = null) {
    return result ? result.getCsvColumns() : [defaultValue, defaultValue, defaultValue, defaultValue, defaultValue];
}
exports.modelResultToCsvData = modelResultToCsvData;
