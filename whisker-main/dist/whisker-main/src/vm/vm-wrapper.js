...
function pause(millis) {
    return new Promise((resolve) => millis === 0
...
class VMWrapper {
    ...
    step() {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.vm.runtime.translateText2Speech();
            yield this.callbacks.callCallbacks(false);
            yield this._yield();
            ...
            yield this._yield();
            yield this.modelCallbacks.callCallbacks(false);
            yield this._yield();
            this.sprites.update();
            yield this._yield();
            ...
            yield this.modelCallbacks.callCallbacks(true);
            yield this._yield();
            if (!this.isScratchRunning()) {
                return null;
            }
            yield this.callbacks.callCallbacks(true);
            yield this._yield();
            if (!this.isScratchRunning()) {
                return null;
            }
     ...
     */
    run({ condition = (() => false), timeout = Infinity, steps = Infinity }) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.isScratchRunning()) {
            ...
            const stopOnError = (this.actionOnConstraintFailure === VMWrapper.ON_CONSTRAINT_FAILURE_FAIL ||
            ...
            while (this.isScratchRunning() && this._runStepsExecuted < steps && !condition()) {
                ...
                [assertionError] = yield Promise.all([
                    this.step(),
    ...
    runForSteps(steps) {
        return __awaiter(this, void 0, void 0, function* () {
            return VMWrapper.convertFromTimeToSteps(yield this.run({ steps }));
        });
    }
    /**
     ...
     */
    setup(project, accelerationFactor = 1) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.waitForProjectLoadFinished();
            const returnValue = yield this.vm.loadProject(project);
            yield this._yield();
            return returnValue;
        });
    }
    ...
    resetVM() {
        return __awaiter(this, void 0, void 0, function* () {
            this.stopModels();
            yield this.waitForProjectLoadFinished();
            yield this.vm.loadProject(this._originalProjectJSON);
            this._totalStepsExecuted = 0;
        });
    }
    /**
